/* ═══════════════════════════════════════════════════════════════════
   ...
   دارد. یعنی نسخهٔ کهنه در کشِ مرورگر مانده بود. با یک‌جلو‌رفتنِ شماره،
   `activate` کش‌های ناکه را پاک می‌کند و پوسته از نو پیش‌ذخیره می‌شود.
   ═══════════════════════════════════════════════════════════════════ */

const CACHE = 'noorestan-18';
const SHELL = 'noorestan-shell-18';
const MEDIA = 'noorestan-media-18';
const TEXT  = 'noorestan-text-18';
